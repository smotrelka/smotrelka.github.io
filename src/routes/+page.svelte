			...
			<div class="max-w-5xl mx-auto w-full p-4">
				{#if searchQuery.trim().length}
					{#if searchResults.length}
						<ul
							class="grid gap-4 grid-cols-[repeat(auto-fill,minmax(90px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(130px,1fr))] text-xs sm:text-sm lg:grid-cols-[repeat(auto-fill,minmax(150px,1fr))]"
						>
